...
final class UpdateChecker: ObservableObject {
    ...
    static var buildInfo: String {
        ...
        let hash = Bundle.main.infoDictionary?["TranscriberGitHash"] as? String ?? ""
    ...
    func installAvailableUpdate() async {
        ...
        do {
            ...
            let work = FileManager.default.temporaryDirectory.appendingPathComponent("TranscriberUpdate-\(UUID().uuidString)", isDirectory: true)
