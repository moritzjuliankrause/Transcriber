...
/// Minimal file logger: ~/Library/Logs/Transcriber.log (also echoed to NSLog).
enum AppLog {
    static let url: URL = {
        ...
        return logs.appendingPathComponent("Transcriber.log")
    }()
    private static let queue = DispatchQueue(label: "transcriber.log")
