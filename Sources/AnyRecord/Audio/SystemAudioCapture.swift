...
final class SystemAudioCapture {
    ...
    private let queue = DispatchQueue(label: "anyrecord.systemaudio", qos: .userInitiated)
    ...
    func start(options: Options = .default) throws {
        ...
        description.name = "AnyRecord System Audio Tap"
        ...
        let aggregateDescription: [String: Any] = [
            kAudioAggregateDeviceNameKey: "AnyRecord Capture",
