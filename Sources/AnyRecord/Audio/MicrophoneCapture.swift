...
final class MicrophoneCapture {
    ...
    private let queue = DispatchQueue(label: "anyrecord.mic", qos: .userInitiated)
    ...
    private func startEngine(deviceUID: String?, echoCancellation: Bool) throws {
        ...
        guard format.sampleRate > 0, format.channelCount > 0 else {
            throw NSError(domain: "AnyRecord", code: 1, userInfo: [NSLocalizedDescriptionKey: "No usable microphone input format."])
        }
