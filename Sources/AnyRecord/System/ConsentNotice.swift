...
enum ConsentNotice {
    ...
    static func showIfNeeded(settings: AppSettings) {
        ...
        alert.informativeText = "AnyRecord records both your microphone and everything your Mac plays. In many countries, including Germany, recording a conversation without informing the other participants is illegal. Please tell people before you record. You can enable a start tone in Settings as a reminder."
